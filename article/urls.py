...
urlpatterns = [
    ...
    # url(r'^article-detail/(?P<id>\d+)/(?P<slug>(%[a-zA-Z0-9][a-zA-Z0-9]*)+)/$', views.article_detail,
    #     name="article_detail"),
    url(r'^article-detail/(?P<id>\d+)/(?P<slug>[0-9a-z]{8}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{4}-[0-9a-z]{12})/$',
